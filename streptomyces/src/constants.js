export const Constants = {
    ...
    MINIMUM_ATP_CONSUMPTION_RATE: 0.2*0.8, // millions of molecules per segment per second. This data is based on the literature. The minimum consumption rate of ATP in living cells is arround 0.15 millions of ATP molecules per second.
    ...
    ATP_PRODUCTION_RATE: 0.12, // Millions of Molecules per second per µm^3 of FOCI
